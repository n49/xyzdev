  ...
  <div id="promotion-term" style="position: absolute; color: rgba(0,0,0,0)">New Year Sale</div>
	...
	<div class="wrapper">
		<div class="tabs">
			...
			<h5 class="title icon icon-arrow">
      	...
      	<div id="<?php echo $category; ?>" <?php post_class('tab margin'); ?>>
			...
			<div class="tabs-wrap has-tooltip">
				<div class="normal-tooltip">
					...
					<div class="tooltip">
						Note: You may have selected a daily or weekly pricing on the Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore.
					</div>
				</div>
				...
				<div class="tabs white toggle active">
					...
					<div id="daily-<?php echo $category; ?>">
						<div class="slider-units" id="flick">
								...
								<div
								  ...
								  <div class="col img" style="margin: 0px">
									...
									<div id="discount-cookie-<?php echo $unitID?>" style="height:0px;width:0px;font-size:0px"></div>
													...
													<div class="col text border">
														<h3  class="title-4 first">$<span style="display:inline" id="unitPriceSection"><?php echo $unitPrice; ?></span><span style="display:inline" id="unitSwitchLabel">/day</span></h3>
													...
													<div class="col last border">
													  <?php if($unitPrice != $unitInternetPrice): ?>
															<del>
																<span id="unit-price-<?php echo $unitID; ?>">
																	$<?php echo $unitPrice; ?>
																</span>
															</del>
															<h3 class="title-4 no-margin" id="unit-sp-price-<?php echo $unitID; ?>"> $<?php echo $unitInternetPrice; ?>/day</h3>
														<p
														...
														<?php else: ?>
															<h3 class="title-4 no-margin  no-special"> $<?php echo $unitInternetPrice; ?>/mo</h3>
														...
														<img id="price-tag-<?php echo $unitID; ?>" class="no-price-tag 22 ls-is-cached lazyloaded" src="https://www.xyzstorage.com/wp-content/uploads/2019/10/Tag@2x.png" data-src="https://www.xyzstorage.com/wp-content/uploads/2019/10/Tag@2x.png">
					...
					<div id="q-<?php echo $category; ?>" class="tab">
						<div class="slider-units" id="flick">
						  <?php foreach($master[$ck] as $unit):  ?>
							<?php if(($unit["AvailableUnits"] != 0 || $unit['UnitTypeId'] == '16') && $this_location_code != 5): ?>
							  <?php
									...
									<div id="discount-cookie-<?php echo $unitID?>" style="height:0px;width:0px;font-size:0px"></div>
													...
													<div class="col last border">
													  <?php if($unitPrice != $unitInternetPrice): ?>
															...
															<h3 class="title-4 no-margin" id="unit-sp-price-<?php echo $unitID; ?>"> $<?php echo $unitInternetPrice; ?>/mo</h3>
														<p
															class="title-5 online-special-flag hide"
														   id="special-flag-<?php echo $unitID; ?>"
														   style="display:none;"
